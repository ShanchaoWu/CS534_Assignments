...
class genetic_algo:
    def __init__(self, board, population = 200, crossover = 3, mutate = 0.2, time = 0, eli_ratio = 0.2, cul_ratio = 0.2, max_gen = 1000):
...
def init_board_list(low_dim=8, up_dim=10, file_name=''): # provide lower and upper boundary of dimension to generate a set of model and board, default lower = 5, upper = 10
    model = None
    board_list = []
